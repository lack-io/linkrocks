...
#[derive(Clone)]
pub struct Config {
    /// The identify of the local raft. It cannot be 0, and must be unique in the group.
    pub id: u64,
    ...
    /// TODO: feadback to application to limit the proposal rate?
    ...
    /// Enables the Pre-Vote algorithm described in raft thesis seciton
    ...
    /// Choose the linearizability mode or the lease mode to read data. If you don't care
    /// about the read consistency and want a higher read performance, you can use the
    /// lease mode.
    ///
    ...
    /// This may make follower wait to longer time to apply an entry. This configuration
    ...
    /// The election prority of this node.
    pub priority: u64,
